...
<main>
    <?php $client_id = filter_var($_GET['client_id'],FILTER_VALIDATE_INT);
    require_once 'utils.php';
    require_once 'config.php';
    if($client_id && DBUtils::is_user_exist($db,$client_id)):
    ?>
    <h1>Оцените качество обслуживания</h1>
    <form action = 'handler.php?client_id=<?php echo $client_id ?>' method = "POST">
